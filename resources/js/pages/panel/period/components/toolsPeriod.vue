<template>
    <div class="flex flex-wrap items-center gap-3 p-2">
        ...
        <!-- Exportar Excel -->
        <a href="/panel/reports/export-excel-periods" download>
        ...
        <!-- Exportar PDF -->
         <a href="/panel/reports/export-pdf-periods" download>
...
const handleFileChange = async (event: Event) => {
    ...
    try {
        await axios.post('/panel/reports/import-excel-periods', formData, {
            headers: {
    ...
    toast({
        ...
        description: 'Los periodos fueron importados correctamente.',
    })
