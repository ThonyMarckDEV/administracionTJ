<template>
    <div class="flex flex-wrap items-center gap-3 p-2">
        ...
        <!-- Exportar Excel -->
        <a href="/panel/reports/export-excel-services" download>
        ...
        <!-- Exportar PDF -->
         <a href="/panel/reports/export-pdf-services" download>
...
const handleFileChange = async (event: Event) => {
    ...
    try {
        await axios.post('/panel/reports/import-excel-services', formData, {
            headers: {
    ...
    toast({
        ...
        description: 'Los srvicios fueron importados correctamente.',
    })
