<template>
    <div class="flex flex-wrap items-center gap-3 p-2">
        ...
        <!-- Exportar Excel -->
        <a href="/panel/reports/export-excel-categories" download>
        ...
        <!-- Exportar PDF -->
         <a href="/panel/reports/export-pdf-categories" download>
...
const handleFileChange = async (event: Event) => {
    ...
    try {
        await axios.post('/panel/reports/import-excel-categories', formData, {
            headers: {
    ...
    toast({
        ...
        description: 'Las categorias fueron importados correctamente.',
    })
