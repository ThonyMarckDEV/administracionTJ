<template>
    <div class="flex flex-wrap items-center gap-3 p-2">
        ...
        <!-- Exportar Excel -->
        <a href="/panel/reports/export-excel-clientTypes" download>
        ...
        <!-- Exportar PDF -->
         <a href="/panel/reports/export-pdf-clientTypes" download>
...
const handleFileChange = async (event: Event) => {
    ...
    try {
        await axios.post('/panel/reports/import-excel-clientTypes', formData, {
            headers: {
    ...
    toast({
        ...
        description: 'Los tipos de cliente fueron importados correctamente.',
    })
