<template>
    <div class="flex flex-wrap items-center gap-3 p-2">
        ...
        <!-- Exportar Excel -->
        <a href="/panel/reports/export-excel-users" download>
        ...
        <!-- Exportar PDF -->
         <a href="/panel/reports/export-pdf-users" download>
...
const handleFileChange = async (event: Event) => {
    ...
    try {
        await axios.post('/panel/reports/import-excel-users', formData, {
            headers: {
    ...
    toast({
        ...
        description: 'Los usuarios fueron importados correctamente.',
    })
