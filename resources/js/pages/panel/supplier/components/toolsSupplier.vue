<template>
    <div class="flex flex-wrap items-center gap-3 p-2">
        ...
        <!-- Exportar Excel -->
        <a href="/panel/reports/export-excel-suppliers" download>
        ...
        <!-- Exportar PDF -->
         <a href="/panel/reports/export-pdf-suppliers" download>
...
const handleFileChange = async (event: Event) => {
    ...
    try {
        await axios.post('/panel/reports/import-excel-suppliers', formData, {
            headers: {
    ...
    toast({
        ...
        description: 'Los proveedores fueron importados correctamente.',
    })
