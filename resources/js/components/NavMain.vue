...
<template>
    <SidebarGroup class="px-2 py-0">
        ...
        <SidebarMenu>
            <Collapsible v-for="item in items4" :key="item.title" as-child :default-open="isMenuActivo(item) || item.isActive"  class="group/collapsible" >
                <SidebarMenuItem>
        ...
        <SidebarGroupLabel>Gestión Proveedores</SidebarGroupLabel>
         <SidebarMenu>
        ...
        <SidebarGroupLabel>Reportes de Finanzas</SidebarGroupLabel>
         <SidebarMenu>
